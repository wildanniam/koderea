    ...
    <section id="contact" className="py-32 px-6 md:px-12 lg:px-24 bg-foreground text-background">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-12">
        <motion.div
          ...
          className="max-w-xl"
        >
          <h2 className="mb-6 text-4xl font-semibold leading-[1.1] tracking-[-0.02em] md:text-6xl">
            Ready to secure your AI adoption?
          </h2>
          <p className="text-lg leading-[1.3] text-white/60">
        ...
        >
          <a
            ...
            className="inline-flex h-14 items-center justify-center rounded-full bg-paper px-8 text-lg font-medium text-foreground transition-transform hover:scale-105 motion-reduce:hover:scale-100"
          >
