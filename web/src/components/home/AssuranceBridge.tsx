...
const controls = [
  { label: "Monitoring & Feedback", lines: ["Monitoring", "& Feedback"], icon: "monitoring.svg", className: "left-[41.08%] top-[15.83%] w-[5.67%]" },
  { label: "Risk & Controls", lines: ["Risk &", "Controls"], icon: "risk.svg", className: "left-[51.17%] top-[15.3%] w-[7.04%]" },
  { label: "Explainability", lines: ["Explainability"], icon: "explainability.svg", className: "left-[33.75%] top-[42.26%] w-[6.71%]" },
  { label: "Policy & Standards", lines: ["Policy & Standards"], icon: "policy.svg", className: "left-[57.5%] top-[42.26%] w-[8.72%]" },
  { label: "Fairness / Bias Checks", lines: ["Fairness / Bias", "Checks"], icon: "fairness.svg", className: "left-[45.67%] top-[65.57%] w-[6.96%]" },
] as const;
        ...
        <div className="mt-12 md:mt-[60px]">
          ...
          >
            <div className="relative aspect-[1200/575] w-[920px] overflow-hidden rounded-[20px] border border-[#e6e6e6] bg-[#fafafa] lg:w-full">
              ...
              <motion.span
                ...
                animate={
                  coreIsActive && !shouldReduceMotion
                    ? { scale: 1.018, filter: "drop-shadow(0px 5px 14px rgba(58,68,85,0.07))" }
              ...
              <motion.div
                className="absolute left-[41.99%] top-[32.7%] z-10 aspect-square w-[14.09%] rounded-full text-center"
                initial={false}
                animate={
                  shouldReduceMotion
                    ? { scale: 1, filter: "drop-shadow(0px 7px 16px rgba(12,15,18,0.07))" }
                    : coreIsActive
                      ? {
                          scale: [1, 1.035, 1],
                          filter: [
                            "drop-shadow(0px 7px 16px rgba(12,15,18,0.07))",
                            "drop-shadow(0px 13px 25px rgba(12,15,18,0.12))",
                            "drop-shadow(0px 7px 16px rgba(12,15,18,0.07))",
                          ],
                        }
                      : {
                          ...
                          filter: [
                            "drop-shadow(0px 7px 16px rgba(12,15,18,0.07))",
                            "drop-shadow(0px 10px 21px rgba(12,15,18,0.09))",
                            "drop-shadow(0px 7px 16px rgba(12,15,18,0.07))",
                          ],
                        }
                }
                transition={{
                  duration: coreIsActive ? 1.8 : 4.8,
                  repeat: shouldReduceMotion ? 0 : Infinity,
                  ease: "easeInOut",
                }}
              >
                <Image src="/bridging/lines/core-surface.svg" alt="" fill sizes="169px" loading="eager" unoptimized />
                <span className="absolute left-[27.3%] top-[17.75%] h-[35.7%] w-[44.4%]">
                  <Image src="/bridging/icons/assurance-mark.svg" alt="" fill sizes="75px" loading="eager" unoptimized />
                </span>
                <p className="absolute inset-x-[20%] top-[59.7%] text-[14px] font-medium leading-[1.1] tracking-[-0.02em] text-[#515151]">
                  Independent
                  <br />
                  Assurance
                  <br />
              ...
              {controls.map((control) => (
                ...
                >
                  <span className="flex size-12 items-center justify-center rounded-full border-[1.2px] border-[#e6e6e6] bg-white shadow-[0_4px_12px_rgba(30,37,48,0.04)] transition-[transform,box-shadow] duration-300 hover:scale-[1.04] hover:shadow-[0_10px_22px_rgba(30,37,48,0.09)]">
                    <AssetIcon name={control.icon} size={29} />
                  </span>
                  <span className="relative z-10 rounded-[4px] bg-[#fafafa] px-1.5 py-0.5 text-[12px] font-medium leading-[1.2] text-[#515151] shadow-[0_0_0_3px_#fafafa]">
